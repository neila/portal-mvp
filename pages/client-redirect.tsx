  ...
  return (
    <>
      <AppLayout title="Client Redirect">
        <div>
          <h1>
            Hello, {session.user.name ?? session.user.email} This is a protected
        ...
        <div className="my-6 p-2">
          ...
          quickly. The advantage of this approach is that session state is
          shared between pages by using the Provider in _app.js so that
          navigation between pages using useSession() is very fast. The
          disadvantage of useSession() is that it requires client side
          JavaScript.
        </div>
        <div className="my-6 p-2">
